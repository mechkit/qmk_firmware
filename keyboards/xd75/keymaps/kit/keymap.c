...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_L1] = {
    ...
    { KC_ESC  , KC_KP_7 , KC_KP_8 , KC_KP_9 , KC_NUMLOCK , KC_TRNS ,  KC_LPRN , KC_RPRN   , KC_SLSH   , KC_ASTR  , KC_GRV  , KC_DEL  , KC_KP_7 , KC_KP_8 , KC_KP_9    } ,
    { KC_TRNS , KC_KP_4 , KC_KP_5 , KC_KP_6 , KC_MINS    , KC_PLUS ,  KC_LCBR , KC_RCBR   , KC_EQL    , KC_UNDS  , KC_QUOT , KC_TRNS , KC_KP_4 , KC_KP_5 , KC_KP_6    } ,
    { KC_TRNS , KC_KP_1 , KC_KP_2 , KC_KP_3 , KC_SLSH    , KC_ASTR ,  KC_LBRC , KC_RBRC   , KC_MINS   , KC_PLUS  , KC_BSLS , KC_TRNS , KC_KP_1 , KC_KP_2 , KC_KP_3    } ,
    { KC_TRNS , KC_KP_0 , KC_ENT  , KC_DOT  , KC_TRNS    , KC_BSPC ,  KC_DEL  , KC_TRNS   , KC_TRNS   , KC_TRNS  , KC_TRNS , KC_TRNS , KC_KP_0 , KC_TRNS , KC_DOT     } ,
  }                                                                                                                                                                     ,

  [_L2] = {
    { KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS    , KC_TRNS ,  KC_TRNS , KC_TRNS   , KC_TRNS   , KC_TRNS  , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , RESET      } ,
    { KC_ESC  , KC_F7   , KC_F8   , KC_F9   , KC_F10     , KC_VOLU ,  KC_HOME , KC_PGUP   , KC_PGUP   , KC_END   , KC_TRNS , RESET   , KC_TRNS , KC_TRNS , KC_TRNS    } ,
    { KC_TRNS , KC_F4   , KC_F5   , KC_F6   , KC_F11     , KC_VOLD ,  KC_LEFT , KC_DOWN   , KC_UP     , KC_RIGHT , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS    } ,
    { KC_TRNS , KC_F1   , KC_F2   , KC_F3   , KC_TRNS    , KC_MUTE ,  KC_HOME , KC_PGDOWN , KC_PGDOWN , KC_END   , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS    } ,
    { KC_TRNS , KC_F10  , KC_TRNS , KC_TRNS , KC_TRNS    , KC_ENT  ,  KC_ENT  , KC_TRNS   , MO(_L3)   , KC_TRNS  , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS    } ,
  }                                                                                                                                                                     ,
